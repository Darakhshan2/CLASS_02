...
/* behaviour of code : line by line  and  top to bottom execution 
 ...
 ; --> statement terminator use for break the line
...
let name1:string = "darakhshan"; // all type of text
let age:number = 18;// all type of number
let isMaried:boolean =false // 2 types
let abc:undefined = undefined //hai to store krdo otherwise undefined
let xyz :null = null // as soon as possible data aye ga data add krskty hen
...
const pi = 3.14 // this will not updatable